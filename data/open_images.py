...
class OpenImagesDataset:
    ...
    def __init__(self, root,
        ...
        self.root = "/home/ruchi/data/open_images"##pathlib.Path(root)
    ...
    def _read_data(self):
        #root = "/home/ruchi/data/open_images"#
        annotation_file = self.root + '/sub-' + self.dataset_type + '-annotations-bbox.csv' #f"{root}/sub-{self.dataset_type}-annotations-bbox.csv"
    ...
    def _read_image(self, image_id):
        ...
        image_file = self.root +'/'+ self.dataset_type +'/'+ image_id + '.jpg'#f"{image_id}.jpg"
